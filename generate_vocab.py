...
def get_generator():
    with open("C:\\Users\\Dorot\\OneDrive\\College\\Graduate\\Classes\\MLClassTranslator\\data\\german\\mixed.txt", encoding="UTF8") as f:
        for line in f:
            yield line.strip()
...
generator_utils.get_or_generate_vocab_inner("C:\\Users\\Dorot\\OneDrive\\College\\Graduate\\Classes\\MLClassTranslator\\data\\german\\t2t_data",
                                            "vocab.cseten.wp", 32000, gen)
